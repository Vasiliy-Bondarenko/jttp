...
/**
 * Status codes list from Symfony package
 * @package Jttp
 */
class StatusCodes
{
    const SAFE_AUTOMATIC_REDIRECTS = [
    ...
    public static function isSafeToAutoRedirect(int $status): bool
    {
        return in_array($status, StatusCodes::SAFE_AUTOMATIC_REDIRECTS);
    }

    public static function isOk(int $status): bool
    {
